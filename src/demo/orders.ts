...
const northline = build({
  ...
  special: {
    ...
    'Lizard Skins DSP 2.5 bar tape · White': { state: 'review',
      reason: 'Road riders usually re-tape in spring. We kept this order light until then.' },
    'Shimano Deore cassette CS-M6100 · 10–51T': { state: 'review',
      reason: 'This model is being replaced in the new year. We ordered just enough to get you there.' },
  },
})
...
const summit = build({
  ...
  special: {
    'RockShox 200-hour service kit · Pike': { state: 'review',
      reason: 'Service kits sell faster once riders stop riding. We ordered ahead of November.' },
    'PNW Rainier dropper post · 150 mm': { state: 'review',
      reason: 'You already have more droppers than usual, so we kept this one small.' },
